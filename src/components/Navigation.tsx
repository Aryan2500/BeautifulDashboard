...
const Navigation = () => {
  ...
  const handleOpenClose = (event: Event) => {
    ...
    <>
      <NavContext.Provider value={isOpen}>
        <motion.nav
          ...
          initial="close"
          className="bg-neutral-900 flex flex-col z-10 gap-20 p-5  top-0 left-0 h-full shadow shadow-neutral-600"
        >
            ...
            {isOpen == true ?
              <div className="flex items-center">
                <img
                  ...
                  alt="Profile"
                />
                <span className="text-white font-semibold text-lg">Aryan</span>
